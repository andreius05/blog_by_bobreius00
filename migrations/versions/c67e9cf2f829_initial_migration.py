...
Revision ID: c67e9cf2f829
Revises: 
Create Date: 2024-09-11 18:08:52.873246
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('man_that_likes_id', sa.Integer(), nullable=True),
    sa.Column('post_id', sa.Integer(), nullable=True),
    sa.Column('is_liking', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['man_that_likes_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['post_id'], ['post.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
